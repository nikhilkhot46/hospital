                        ...
                        <?php if (!empty($wastage)) { ?>
                            ...
                            <?php foreach ($wastage as $waste) { ?>
                                <tr class="<?php echo ($sl & 1)?"odd gradeX":"even gradeC" ?>">
                                    <td><?php echo $sl; ?></td>
                                    <td><?php echo $waste->wastage_id ?></td>
                                    <td><?php echo $this->config->item('blood_group')[$waste->blood_type] ?></td>
                                    <td><?php echo $waste->qty; ?></td>
                                    <td><?php echo $waste->added_date; ?></td>
                                    <td class="center">
                                        <a href="<?php echo base_url("blood_bank/blood/add_wastage/$waste->wastage_id") ?>" class="btn btn-xs btn-primary"><i class="fa fa-edit"></i></a>
                                    </td>
                                </tr>
                                <?php $sl++; ?>
                            <?php } ?> 
