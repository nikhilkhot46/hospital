    ...
    <div class="col-sm-12">
        <div class="panel panel-default thumbnail">
            ...
            <div class="panel-heading">
                <div class="btn-group">
                    <a class="btn btn-primary" href="<?php echo base_url("dashboard_laboratorist/lab_manager/package") ?>"> <i class="fa fa-list"></i>  <?php echo display('package_list') ?> </a>
                </div>
            </div>
            ...
            <div class="panel-body panel-form">
                <div class="row">
                    <div class="col-md-12 col-sm-12">
                        ...
                        <?php echo form_open('dashboard_laboratorist/lab_manager/package/form/' . $package->package_id, 'class="form-inner"') ?>
