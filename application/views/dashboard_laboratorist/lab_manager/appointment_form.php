    ...
    <div class="col-sm-12">
        <div  class="panel panel-default thumbnail">
            ...
            <div class="panel-heading no-print">
                <div class="btn-group"> 
                    <a class="btn btn-primary" href="<?php echo base_url("dashboard_laboratorist/lab_manager/appointment/") ?>"> <i class="fa fa-list"></i>  <?php echo display('appointment_list') ?> </a>  
                </div>
            </div> 
            ...
            <div class="panel-body panel-form">
                <div class="row">
                    <div class="col-md-9 col-sm-12">
                        <?php echo form_open('dashboard_laboratorist/lab_manager/appointment/form/'.$appointment->appointment_id,'class="form-inner"') ?> 
...
$(document).off('change.test').on('change.test', '#test', function(event) {
    if($(this).val()){
        $('#discount').val(0);
        var url = '<?php echo base_url() ?>dashboard_laboratorist/lab_manager/test/getTestPrice';
        $.ajax({
            type: "POST",
            url: url,
...
$(document).off('change.package').on('change.package', '#package', function(event) {
    if($(this).val()){
        $('#discount').val(0);
        var url = '<?php echo base_url() ?>dashboard_laboratorist/lab_manager/package/getPackagePrice';
        $.ajax({
            type: "POST",
            url: url,
