    ...
    <div class="col-sm-12">
        <div  class="panel panel-default thumbnail"> 
            ...
            <div class="panel-heading">
                <div class="btn-group">
                    <a class="btn btn-success" href="<?php echo base_url("dashboard_laboratorist/patient/document") ?>"> <i class="fa fa-list"></i>  <?php echo display('document_list') ?> </a>  
                </div>
            </div>
            ...
            <div class="panel-body">
                <div class="row">
                    ...
                    <div class="col-md-9 col-sm-12">
                        ...
                        <?php echo form_open_multipart('dashboard_laboratorist/patient/document_form','class="form-inner" id="mailForm" ') ?>

                            <div class="form-group row">
                                <label for="patient_id" class="col-xs-3 col-form-label"><?php echo display('patient_id')?> <i class="text-danger">*</i></label>
                                <div class="col-xs-9">
                                    <input name="patient_id" onchange="checkid(this.value)"  type="text" class="form-control" id="patient_id" placeholder="<?php echo display('patient_id')?>" value="<?php echo (($this->uri->segment(4)!=null)?$this->uri->segment(4):$document->patient_id) ?>">
...
$(function(){
    ...
    browseFile.on('change',function(e)
    {
        ...
        $.ajax({
            url      : '<?php echo base_url('dashboard_laboratorist/patient/do_upload') ?>',
...
function checkid(pid){
        ...
        $.ajax({
            url  : '<?= base_url('dashboard_laboratorist/patient/check_patient/') ?>',
            type : 'post',
            dataType : 'JSON',
            data : {
