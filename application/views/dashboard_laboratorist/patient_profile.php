    ...
    <div class="col-sm-12" id="PrintMe">
        <div  class="panel panel-default thumbnail">
            ...
            <div class="panel-heading no-print">
                <div class="btn-group"> 
                    <a class="btn btn-success" href="<?php echo base_url("dashboard_laboratorist/patient/create") ?>"> <i class="fa fa-plus"></i>  <?php echo display('add_patient') ?> </a>  
                    <a class="btn btn-primary" href="<?php echo base_url("dashboard_laboratorist/patient") ?>"> <i class="fa fa-list"></i>  <?php echo display('patient_list') ?> </a>  
                    ...
                    <div role="tabpanel" class="tab-pane" id="profile">
                        <div class="row">
                            ...
                            <div class="col-sm-12 no-print">
                                <?php echo form_open_multipart('dashboard_laboratorist/patient/profile/'.$profile->id) ?>
                                    <?php echo form_hidden('patient_id',$profile->id) ?>
                                    ...
                                    <div class="form-group"> 
                                        <div class="text-right">
                                            ...
                                            <?php if ($status->id) { ?>
                                                <a href="<?php echo base_url('dashboard_laboratorist/patient/profile/'.$profile->id) ?>" class="ui  btn-info btn"><?php echo display('add_new_status') ?></a>
                                                <div class="or"></div>
                                            <?php } ?>
                                            ...
                                            <?php foreach ($statuss as $status) { ?>
                                                <tr>
                                                    ...
                                                    <td class="no-print" width="80">
                                                        <a href="<?php echo base_url("dashboard_laboratorist/patient/profile/$profile->id/$status->id") ?>" onclick="return confirm('<?php echo display("are_you_sure") ?>')" class="btn btn-xs  btn-primary"><i class="fa fa-edit"></i></a>

                                                        <a href="<?php echo base_url("dashboard_laboratorist/patient/delete_status/$status->id") ?>" onclick="return confirm('<?php echo display("are_you_sure") ?>')" class="btn btn-xs  btn-danger"><i class="fa fa-trash"></i></a> 
                                                    </td>
                                                </tr>
                                                <?php $sl++; ?>
                                            <?php } ?> 
                                            ...
                                            <?php foreach ($documents as $document) { ?>
                                                <tr>
                                                    ...
                                                    <td class="center no-print" width="110"> 
                                                        ...
                                                        <a href="<?php echo base_url("dashboard_laboratorist/patient/document_form/$document->patient_id") ?>" class="btn btn-xs btn-warning" title="Add Document"><i class="fa fa-plus"></i></a> 
                                                        ...
                                                        <a href="<?php echo base_url("dashboard_laboratorist/patient/document_delete/$document->id?file=$document->hidden_attach_file") ?>" class="btn btn-xs btn-danger" onclick="return confirm('<?php echo display('are_you_sure') ?>') "><i class="fa fa-trash"></i></a> 
                                                    </td>
                                                </tr>
                                                <?php $sl++; ?>
                                            <?php } ?> 
