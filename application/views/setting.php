                ...
                <div class="row">
                    <div class="col-md-9 col-sm-12">
                        <?php echo form_open_multipart('setting/create','class="form-inner"') ?>
                            ...
                            <div class="form-group row">
                                <label for="currency" class="col-xs-3 col-form-label"><?php echo display('currency') ?></label>
                                <div class="col-xs-9">
                                    <input name="currency" type="text" class="form-control" id="currency" placeholder="<?php echo display('currency') ?>"  value="<?php echo $setting->currency ?>">
                                </div>
                            </div>

                            <div class="form-group row">
                                <label class="col-sm-3"><?php echo display('currency_position') ?></label>
                                <div class="col-xs-9">
                                    <div class="form-check">
                                        <label class="radio-inline">
                                        <input type="radio" name="currency_position" value="0" <?php echo set_radio('currency_position', '0', $setting->currency_position==0?TRUE:""); ?> ><?php echo display('left') ?>
                                        </label>
                                        <label class="radio-inline">
                                        <input type="radio" name="currency_position" value="1" <?php echo set_radio('currency_position', '1', $setting->currency_position==1?TRUE:""); ?> ><?php echo display('right') ?>
                                        </label>
                                    </div>
                                </div>
                            </div>
