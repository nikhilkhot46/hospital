    ...
    <div class="col-sm-12">
        <div class="panel panel-default thumbnail">
            ...
            <div class="panel-heading">
                <div class="btn-group">
                    <a class="btn btn-success" href="<?php echo base_url("lab_manager/appointment/form") ?>"> <i class="fa fa-plus"></i>  <?php echo display('add_appointment') ?> </a>  
                </div>
                <div class="btn-group">
                    <a class="btn btn-success" href="<?php echo base_url("lab_manager/appointment/todays_appointments") ?>"> <i class="fa fa-plus"></i>  <?php echo display('todays_appointment') ?> </a>  
                </div>
            </div>
                        ...
                        <?php if (!empty($appointment)) { ?>
                            ...
                            <?php foreach ($appointment as $pack) { ?>
                                <tr class="<?php echo ($sl & 1)?"odd gradeX":"even gradeC" ?>">
                                    ...
                                    <td class="center">
                                        <?php if($pack->status != 4){?><a href="<?php echo base_url("lab_manager/appointment/form/$pack->appointment_id") ?>" class="btn btn-xs  btn-primary"><i class="fa fa-edit"></i></a> <?php }?>
...
<div id="myModal" class="modal" role="dialog">
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      ...
      <?php echo form_open_multipart('lab_manager/appointment/report','class="form-inner"') ?> 
