    ...
    <div class="col-sm-12">
        <div  class="panel panel-default thumbnail">
            ...
            <div class="panel-heading no-print">
                ...
                <div class="btn-group"> 
                    <a class="btn btn-success" href="<?php echo base_url("dashboard_receptionist/appointment/appointment/todays_appointment") ?>"> <i class="fa fa-plus"></i>  <?php echo display('todays_appointment') ?> </a>  
                </div>
            </div> 
            ...
            ?>
                ...
                ?>
                <table width="100%" class="datatable table table-striped table-bordered table-hover">
                <caption>Todays Appoinments</caption>
                    <thead>
                        <tr>
                            <th><?php echo display('serial') ?></th>
                            <th><?php echo display('appointment_id') ?></th>
