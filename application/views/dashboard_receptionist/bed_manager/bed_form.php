    ...
    <div class="col-sm-12">
        <div class="panel panel-default thumbnail">
            ...
            <div class="panel-heading">
                <div class="btn-group">
                    <a class="btn btn-primary" href="<?php echo base_url("dashboard_receptionist/bed_manager/bed") ?>"> <i class="fa fa-list"></i>  <?php echo display('bed_list') ?> </a> 
                </div>
            </div>
            ...
            <div class="panel-body panel-form">
                <div class="row">
                    <div class="col-md-9 col-sm-12">
                        ...
                        <?php echo form_open('dashboard_receptionist/bed_manager/bed/form/'.$bed->id,'class="form-inner"') ?>
