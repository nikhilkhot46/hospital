                ...
                <div class="sidebar">
                    ...
                    <ul class="sidebar-menu"> 
                        ...
                        <li class="treeview <?php echo (($this->uri->segment(2) == "bed_manager") ? "active" : null) ?>">
                            ...
                            <ul class="treeview-menu">
                                <li><a href="<?php echo base_url("dashboard_receptionist/bed_manager/bed/form") ?>"><?php echo display('add_bed') ?></a></li> 
                        ...
                        <li class="treeview <?php echo (($this->uri->segment(2) == "billing") ? "active" : null) ?>">
                            ...
                            <ul class="treeview-menu">
                                <li><a href="<?php echo base_url("dashboard_receptionist/billing/service/form") ?>"><?php echo display('add_service') ?></a></li> 
                                <li><a href="<?php echo base_url("dashboard_receptionist/billing/service/index") ?>"><?php echo display('service_list') ?></a></li>  
                                <li><a href="<?php echo base_url("dashboard_receptionist/billing/package/form") ?>"><?php echo display('add_package') ?></a></li>  
                                <li><a href="<?php echo base_url("dashboard_receptionist/billing/package/index") ?>"><?php echo display('package_list') ?></a></li>   
