        ...
        <div class="panel panel-bd billing-panel ">
            ...
            <div class="panel-heading no-print row">
                <div class="btn-group col-xs-3"> 
                    <a class="btn btn-primary" href="<?php echo base_url("dashboard_receptionist/billing/bill") ?>"> <i class="fa fa-list"></i>  <?php echo display('bill_list') ?> </a>  
            ...
            <?php echo form_open('dashboard_receptionist/billing/bill/edit/'.$bill->bill_id, array('class'=>'billig-form')) ?>
