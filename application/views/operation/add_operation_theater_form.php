                    ...
                    <div class="col-md-9 col-sm-12">
                        ...
                        <?php echo form_open('operation/operation/add_theater/','class="form-inner"') ?>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-xs-9">
                                    <input name="name"  type="text" class="form-control" id="name" placeholder="<?php echo display('ot_name') ?>">
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-xs-9">
                                    <textarea name="description" class="form-control"  placeholder="<?php echo display('ot_description') ?>" rows="7"></textarea>
                                </div>
                            </div>
                            <!--Radio-->
                            <div class="form-group row">
