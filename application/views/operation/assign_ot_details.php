        ...
        <div class="panel panel-default thumbnail">
            ...
            <div class="panel-footer">
                <dl class="dl-horizontal">
                    ...
                    <?php if (!empty($details->patient_id)) { ?>
                        <dt><?php echo display('patient_name') ?></dt>
                        <dd><?php echo $details->patient_name ?></dd>
                    <?php } ?>
                    ...
                    <?php if (!empty($details->start_time)) { ?>
                        <dt><?php echo display('start_time') ?></dt>
                        <dd><?php echo date('H:i', strtotime($details->start_time)) ?></dd>
                    <?php } ?>

                    <?php if (!empty($details->end_time)) { ?>
                        <dt><?php echo display('end_time') ?></dt>
                        <dd><?php echo date('H:i', strtotime($details->end_time)) ?></dd>
                    <?php } ?>

                    <?php if (!empty($details->status)) { ?>
                        <dt><?php echo display('status') ?></dt>
                        <dd><?php echo (($details->status==1)?display('active'):display('inactive')); ?></dd>
                    <?php } ?>
                </dl>
            </div>
        </div>
