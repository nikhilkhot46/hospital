                ...
                <div class="row">
                    <div class="col-md-9 col-sm-12">
                        ...
                        <?php echo form_open('operation/operation/assign_equipment/','class="form-inner"') ?>
                            ...
                            <?php echo form_hidden('assign_id','') ?>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-xs-9">
                                    ...
                                    <?php
                                        foreach ($ot as $o) {
                                    ?>
                                        <option value="<?= $o->ot_id ?>"><?= $o->ot_name ?></option>
                                    <?php
                                        }
                                    ?>
                                    </select>
                            ...
                            <div class="form-group row">
                                ...
                                <select class="form-control" name="equip_name" id="equip_name">
                                    ...
                                    ?>
                                        <option value="<?= $eq->equip_id ?>"><?= $eq->equip_name ?></option>
                                    <?php
                                        }
                                    ?>
                                    </select>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-xs-9">
                                    <input name="equip_qty" pattern="\d*" oninvalid="this.setCustomValidity('Enter digits only')" oninput="this.setCustomValidity('')"  type="text" class="form-control" id="equip_qty" placeholder="<?php echo display('quantity') ?>">
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="date" class="col-xs-3 col-form-label"><?php echo display('date') ?></label>
                                <div class="col-xs-9">
                                    <input name="date" type="text" class="datepicker-avaiable-days form-control" id="date" placeholder="<?php echo display('date') ?>">
                                </div>
                            </div>
<!--                             
                            <div class="form-group row">
