                ...
                <div class="row">
                    <div class="col-md-9 col-sm-12">
                        ...
                        <?php echo form_open('operation/operation/add_equipment/','class="form-inner"') ?>
                            ...
                            <?php echo form_hidden('equip_id','') ?>

                            <div class="form-group row">
                                <label for="equip_name" class="col-xs-3 col-form-label"><?php echo display('equip_name') ?> <i class="text-danger">*</i></label>
                                <div class="col-xs-9">
                                    <input name="equip_name" required  type="text" class="form-control" id="equip_name" placeholder="<?php echo display('equip_name') ?>">
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-xs-9">
                                    <input name="quantity" pattern="\d*" oninvalid="this.setCustomValidity('Enter digits only')" oninput="this.setCustomValidity('')"  type="text" class="form-control" id="quantity" placeholder="<?php echo display('quantity') ?>">
                                </div>
                            </div>
