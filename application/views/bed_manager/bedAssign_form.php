                    ...
                    <div class="col-md-9 col-sm-12">
                        ...
                        <?php echo form_open('bed_manager/bed_assign/create','class="form-inner"') ?>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-xs-9">
                                    <input name="patient_id" type="text" class="form-control" id="patient_id" placeholder="<?php echo display('patient_id') ?>" value="<?php echo $bed->patient_id ?>" autocomplete="on">
