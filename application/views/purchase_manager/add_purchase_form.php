<!-- Product Purchase js -->
<script src="<?php echo base_url()?>my-assets/js/admin_js/json/item_purchase.js.php" ></script>
<!-- Supplier Js -->
<script src="<?php echo base_url(); ?>my-assets/js/admin_js/json/supplier.js.php" ></script>

<script src="<?php echo base_url()?>my-assets/js/admin_js/item.js" type="text/javascript"></script>
<style type="text/css">
    .close{color:white;}
</style>
        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="panel panel-bd lobidrag">
                    ...
                    <?php echo form_open_multipart('purchase_manager/item/insert_purchase',array('class' => 'form-vertical', 'id' => 'insert_purchase','name' => 'insert_purchase'))?>
                               ...
                               <div class="form-group row">
                                    ...
                                    <div class="col-sm-6">
                                        <select name="supplier_id" id="supplier_id" class="form-control " required tabindex="1" onchange="product_pur_or_list()"> 
                                            ...
                                            foreach ($all_supplier as $suplier) {
                                              ?>
                                              <option value="<?= $suplier['supplier_id'] ?>"><?= $suplier['supplier_name'] ?></option>
                                              <?php  
                                            }
                                            ?>
                                        </select>
                        ...
                        <div class="row">
                            <div class="col-sm-6">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <input value="<?= $invoice_no ?>" readonly type="text" tabindex="3" class="form-control" name="chalan_no" placeholder="<?php echo display('invoice_no') ?>" id="invoice_no" required />
                                    </div>
                                </div>
                            </div>
                                ...
                                <tbody id="addPurchaseItem">
                                    <tr>
                                        <td class="span3 supplier">
                                           <input type="text" name="item_name" required class="form-control item_name productSelection" onkeypress="product_pur_or_list(1);" placeholder="<?php echo display('item_name') ?>" id="item_name_1" tabindex="5" >
