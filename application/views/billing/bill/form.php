                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            <input type="text" class="form-control" id="patient_id" value="" placeholder="<?php echo display('patient_id') ?>" disabled required/>
                                        </div>
                                    </div>
                                </div>
                            </div>
...
table tr th{
    background-color: rgb(235, 237, 242) !important;
                ...
                <div id="bedservices" class="table-responsive">
                    <!-- bed data load-->    
                </div>

                <div id="labservices" class="table-responsive">
                    <!-- lab appointment data load-->    
                </div>

                <div id="medicineservices" class="table-responsive">
                    <!-- medicine data load-->    
                </div>

                <div id="patient_services" class="table-responsive">
                    <!-- medicine data load-->    
                </div>
        ...
        $.ajax({
            ...
            {  
                ...
                if (data.status==true)
                {
                    ...
                    //bed details
                    $("#bedservices").html(data.bed_service);

                    //lab appointment details
                    $("#labservices").html(data.lab_service);

                    //medicine details
                    $("#medicineservices").html(data.med_service);

                    //patient services details
                    $("#patient_services").html(data.patient_service);
