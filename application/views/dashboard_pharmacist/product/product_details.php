	    ...
	    <div class="row">
            <div class="col-sm-12">
                  ...
                  <a href="<?php echo base_url('dashboard_pharmacist/hospital_activities/Cproduct/add_product_csv')?>" class="btn btn-success m-b-5 m-r-2"><i class="ti-plus"> </i> <?php echo display('add_product_csv')?> </a>
		                    ...
		                    <table id="dataTableExample2" class="table table-bordered table-striped table-hover">
								...
								?>
									<tr>
										...
										<td>
											<a href="<?php echo base_url().'dashboard_pharmacist/supplier/Csupplier/supplier_details/'.$purchase['supplier_id'] ?>"><?= $purchase['supplier_name'] ?></a>
										</td>
