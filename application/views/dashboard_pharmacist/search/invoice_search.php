			...
			<div class="col-sm-12">
		        <div class="panel panel-default">
		            <div class="panel-body"> 
						<?php echo form_open('dashboard_pharmacist/search/Csearch/invoice_search',array('class' => 'form-inline', 'id' => 'validate'));?>
			                    ...
			                    <table class="table table-bordered table-striped table-hover medicine_search">
									...
									?>
										<tr>
											...
											<td><a href="<?php echo base_url('dashboard_pharmacist/patient/Cpatient/customerledger/'.$search['customer_id'])?>" target = "_blank"><?= $search['customer_id'] ?></a></td>
											<td><?= $search['quantity'] ?></td>
											<td align="right"><?php echo (($position==0)?$currency." ".$search['total_price']:$search['total_price']." ".$currency) ?></td>
											<td align="right"><?php echo (($position==0)?$currency." ".$search['due_amount']:$search['due_amount']." ".$currency) ?></td>
											<td align="center">
												<a href="<?php echo base_url('dashboard_pharmacist/invoice/Cinvoice/invoice_inserted_data/'.$search['invoice_id']);?>" target="_blank"><button class="btn btn-success"><?php echo display('details')?></button>
												</a>
											</td>
										</tr>
									<?php
