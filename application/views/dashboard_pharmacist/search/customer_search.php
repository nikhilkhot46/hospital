			...
			<div class="col-sm-12">
		        <div class="panel panel-default">
		            <div class="panel-body"> 
						<?php echo form_open('dashboard_pharmacist/search/Csearch/customer_search',array('class' => 'form-inline', 'id' => 'validate'));?>
			                    ...
			                    <table class="table table-bordered table-striped table-hover medicine_search">
									...
									?>
										<tr>
											...
											<td><?= $search['email'] ?></td>
											<td align="center">
											<a href="<?php echo base_url('dashboard_pharmacist/patient/Cpatient/customerledger/'.$search['patient_id']);?>" target="_blank"><button class="btn btn-success"><?php echo display('details')?></button>
											</a>
											</td>
										</tr>
									<?php
