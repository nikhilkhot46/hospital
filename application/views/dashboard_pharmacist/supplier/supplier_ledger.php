			...
			<div class="col-sm-12">
		        <div class="panel panel-default">
		            <div class="panel-body"> 
		            	<?php echo form_open('dashboard_pharmacist/supplier/Csupplier/supplier_ledger',array('class' => '', 'id' => 'validate'))?>
									...
									if ($ledger) {
									 ...
									 ?>
										<tr>
											...
											<td>
												<a href="<?php echo base_url('dashboard_pharmacist/purchase/Cpurchase/purchase_details_data/'. $ledger['transaction_id'])?>"><?php echo $ledger['chalan_no'] ?></a>
											</td>
