    ...
    .show { display: block; }
        ...
        <div class="row">
            <div class="col-sm-12">
                  ...
                  <a href="<?php echo base_url('dashboard_pharmacist/payment/Cpayment/manage_payment')?>" class="btn btn-success m-b-5 m-r-2"><i class="ti-align-justify"> </i><?php echo display('manage_transaction')?></a>
        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="panel panel-bd lobidrag">
                  ...
                  <?php echo form_open('dashboard_pharmacist/payment/Cpayment/transection_entry', array('class' => 'form-vertical','id' => 'validate'))?>
                        ...
                        <div class="form-group row">
                            ...
                            <label for="supplier_id" class="col-sm-2 col-form-label"><span id="demo"></span></label>
                            <div class="col-sm-4">
