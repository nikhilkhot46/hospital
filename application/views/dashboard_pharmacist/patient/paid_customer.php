	    ...
	    ?>
	   	...
	   	<div class="row">
            <div class="col-sm-12">
                  ...
                  <a href="<?php echo base_url('dashboard_pharmacist/patient/Cpatient/credit_customer')?>" class="btn btn-warning m-b-5 m-r-2"><i class="ti-align-justify"> </i>  <?php echo display('credit_customer')?> </a>
			...
			<div class="col-sm-12">
		        <div class="panel panel-default">
					...
					<style>
						...
						<form action="<?php echo base_url('dashboard_pharmacist/patient/Cpatient/paid_customer_search_item')?>" class="form-inline" method="post" accept-charset="utf-8">
							...
							foreach ($all_paid_customer_list as $customer) {
							?>
