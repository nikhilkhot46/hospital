            ...
            <div class="col-sm-12">
                <div class="panel panel-bd lobidrag">
                    ...
                    <div class="panel-body">
                                   <?php echo form_open_multipart('dashboard_pharmacist/purchase/Cpurchase/purchase_update',array('class' => 'form-vertical', 'id' => 'purchase_update'))?>
                            ...
                            <div class="col-sm-6">
                               <div class="form-group row">
                                   ...
                                   <div class="col-sm-6">
                                    ...
                                    <div class="col-sm-3">
                                        <a href="<?php echo base_url('dashboard_pharmacist/supplier/Csupplier'); ?>"><?php echo display('add_supplier') ?></a>
                                    </div>
                                </div> 
                            </div>
                                ...
                                <tbody id="addPurchaseItem">
                                    ...
                                    <tr>
                                        <td class="span3 supplier">
                                           <input type="text" name="product_name" required class="form-control product_name productSelection" onkeypress="product_pur_or_list(<?= $purchase['sl']?>);" placeholder="<?php echo display('product_name') ?>" id="product_name_<?= $purchase['sl']?>" tabindex="5" value="<?= $purchase['product_name'] ?>"  >

                                            <input type="hidden" class="autocomplete_hidden_value product_id_<?= $purchase['sl']?>" name="product_id[]" id="SchoolHiddenId" value="<?= $purchase['product_id'] ?>"/>

                                            <input type="hidden" class="sl" value="<?= $purchase['sl']?>">
                                        </td>
                                         <td>
                                                <input type="text" name="batch_id[]" id="batch_id_<?= $purchase['sl']?>" class="form-control text-right"  tabindex="11" placeholder="<?php echo display('batch_id') ?>" required="" value="<?= $purchase['batch_id'] ?>"/>
                                            </td>
                                            <td>
                                                <input type="text" name="expeire_date[]" id="expeire_date_<?= $purchase['sl']?>" class="form-control datepicker"   tabindex="12" placeholder="<?php echo display('expeire_date') ?>" value="<?= $purchase['expeire_date'] ?>" required=""/>
                                            </td>
...
function product_pur_or_list(sl) {
    ...
    var options = {
        ...
        $.ajax( {
          url: "<?php echo base_url('dashboard_pharmacist/purchase/Cpurchase/product_search_by_supplier')?>",
          method: 'post',
          dataType: "json",
          data: {
            term: request.term,
       ...
       select: function( event, ui ) {
          ...
          var  supplier_id=$('#supplier_id').val();
            ...
            $.ajax({
                type: "POST",
                url: base_url+"dashboard_pharmacist/invoice/Cinvoice/retrieve_product_data",
