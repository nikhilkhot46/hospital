	    ...
	    <div class="row">
            <div class="col-sm-12">
                  <a href="<?php echo base_url('dashboard_pharmacist/purchase/Cpurchase')?>" class="btn btn-success m-b-5 m-r-2"><i class="ti-plus"> </i> <?php echo display('add_purchase')?> </a>

                  <a href="<?php echo base_url('dashboard_pharmacist/purchase/Cpurchase/manage_purchase')?>" class="btn btn-info m-b-5 m-r-2"><i class="ti-align-justify"> </i> <?php echo display('manage_purchase')?> </a>
            </div>
        </div>
		                    ...
		                    <table id="dataTableExample2" class="table table-bordered table-striped table-hover">
								...
								?>
									<tr>
										<td><?= $purdata['sl'] ?></td>
										<td>
											<a href="<?php echo base_url().'dashboard_pharmacist/hospital_activities/Cproduct/product_details/'.$purdata['product_id']; ?>">
											<?= $purdata['product_name'] ?> - (<?= $purdata['product_model']?>)
											</a>
										</td>
