...
<div role="tabpanel" class="tab-pane" id="profile">
                        <div class="row">
                            ...
                            <div class="col-sm-12 no-print">
                                <?php echo form_open_multipart('dashboard_doctor/patient/patient/profile/'.$profile->id) ?>
                                    ...
                                    <div class="form-group"> 
                                        <div class="text-right">
                                            ...
                                            <?php if ($status->id) { ?>
                                                <a href="<?php echo base_url('dashboard_doctor/patient/patient/profile/'.$profile->id) ?>" class="ui  btn-info btn"><?php echo display('add_new_status') ?></a>
                                                <div class="or"></div>
                                            <?php } ?>
                                            ...
                                            <?php foreach ($statuss as $status) { ?>
                                                <tr>
                                                    ...
                                                    <td class="no-print" width="80">
                                                        <a href="<?php echo base_url("dashboard_doctor/patient/patient/profile/$profile->id/$status->id") ?>" onclick="return confirm('<?php echo display("are_you_sure") ?>')" class="btn btn-xs  btn-primary"><i class="fa fa-edit"></i></a>

                                                        <a href="<?php echo base_url("dashboard_doctor/patient/patient/delete_status/$status->id") ?>" onclick="return confirm('<?php echo display("are_you_sure") ?>')" class="btn btn-xs  btn-danger"><i class="fa fa-trash"></i></a> 
                                                    </td>
                                                </tr>
                                                <?php $sl++; ?>
                                            <?php } ?> 
