		                    ...
		                    <table id="dataTableExample2" class="table table-bordered table-striped table-hover">
								...
								<?php
									if ($suppliers_list) {
										...
										<td>
											<a href="<?php echo base_url().'supplier/Csupplier/supplier_ledger_info/'.$supplier->supplier_id ?>">
										...
										<td>
											<center>
												<a href="<?php echo base_url().'supplier/Csupplier/supplier_update_form/'.$supplier->supplier_id; ?>" class="btn btn-info btn-sm" data-toggle="tooltip" data-placement="left" title="<?php echo display('update') ?>"><i class="fa fa-pencil" aria-hidden="true"></i></a>
...
<script type="text/javascript">
	...
	{	
	   ...
	   ({
			type: "POST",
			url: '<?php echo base_url('supplier/Csupplier/supplier_delete')?>',
