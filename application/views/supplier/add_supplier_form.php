        ...
        <div class="row">
            <div class="col-sm-12">
                  ...
                  <a href="<?php echo base_url('supplier/Csupplier/manage_supplier')?>" class="btn btn-info m-b-5 m-r-2"><i class="ti-align-justify"> </i> <?php echo display('manage_supplier')?> </a>
        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="panel panel-bd lobidrag">
                   ...
                   <?php echo form_open_multipart('supplier/Csupplier/insert_supplier',array( 'id' => 'insert_supplier'))?>
