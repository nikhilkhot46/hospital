    ...
    document.body.innerHTML = originalContents;
		...
		<div class="row">
            <div class="col-sm-12">
                  ...
                  <a href="<?php echo base_url('supplier/Csupplier/supplier_ledger_report')?>" class="btn btn-success m-b-5 m-r-2"><i class="ti-align-justify"> </i>  <?php echo display('supplier_ledger')?> </a>
