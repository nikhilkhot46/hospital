            ...
            <aside class="main-sidebar">
                ...
                <div class="sidebar">
                    ...
                    <ul class="sidebar-menu">
                        ...
                        <li class="treeview <?php if ($this->uri->segment('2') == ("Csupplier")) { echo "active";}else{ echo " ";}?>">
                            <a href="#">
                            ...
                            <ul class="treeview-menu">
                                <li><a href="<?php echo base_url('supplier/Csupplier')?>"><?php echo display('add_supplier') ?></a></li>
                                <li><a href="<?php echo base_url('supplier/Csupplier/manage_supplier')?>"><?php echo display('manage_supplier') ?></a></li>
                                <li><a href="<?php echo base_url('supplier/Csupplier/supplier_ledger_report')?>"><?php echo display('supplier_ledger') ?></a></li>
                                <li><a href="<?php echo base_url('supplier/Csupplier/supplier_sales_details_all')?>"><?php echo display('supplier_sales_details') ?></a></li> 
                            </ul>
                        </li>

                        <li class="treeview <?php echo (($this->uri->segment(1) == "blood_bank") ? "active" : null) ?>">
                            <a href="#">
                                <i class="fa fa-map-marker" style="transform: rotate(180deg);margin-left: -8px;"></i> <span><?php echo display('blood_bank') ?> </span>
                                <span class="pull-right-container">
                                    <i class="fa fa-angle-left pull-right"></i>
                                </span>
                            </a>
                            <ul class="treeview-menu">
                                <li><a href="<?php echo base_url("blood_bank/blood/form") ?>"><?php echo display('purchase_blood') ?></a></li>
                                <li><a href="<?php echo base_url("blood_bank/blood") ?>"><?php echo display('blood_stock') ?></a></li>
                                <li><a href="<?php echo base_url("blood_bank/blood/sell_blood") ?>"><?php echo display('sell_blood') ?></a></li>
                                <li><a href="<?php echo base_url("blood_bank/blood/blood_doners") ?>"><?php echo display('blood_doners') ?></a></li>
                                <li><a href="<?php echo base_url("blood_bank/blood/report") ?>"><?php echo display('report') ?></a></li>
                                <li><a href="<?php echo base_url("blood_bank/blood/wastage") ?>"><?php echo display('wastage') ?></a></li>
                            </ul>
                        </li>

                        <li class="treeview <?php echo (($this->uri->segment(1) == "purchase_manager") ? "active" : null) ?>">
                            <a href="#">
                                <i class="fa fa-cart-plus"></i> <span><?php echo display('purchase') ?> </span>
                                <span class="pull-right-container">
                                    <i class="fa fa-angle-left pull-right"></i>
                                </span>
                            </a>
                            <ul class="treeview-menu">
                                <li><a href="<?php echo base_url("purchase_manager/item/add") ?>"><?php echo display('add_item') ?></a></li>
                                <li><a href="<?php echo base_url("purchase_manager/item") ?>"><?php echo display('item_list') ?></a></li>
                                <li><a href="<?php echo base_url("purchase_manager/item/purchase") ?>"><?php echo display('add_purchase') ?></a></li>
                                <li><a href="<?php echo base_url("purchase_manager/item/manage_purchase") ?>"><?php echo display('manage_purchase') ?></a></li>
                            </ul>
                        </li>
                        ...
                        <li class="treeview <?php echo (($this->uri->segment(1) == "lab_manager") ? "active" : null) ?>">
                            <a href="#">
                                <i class="fa fa-hospital-o"></i> <span><?php echo display('lab_manager') ?> </span>
                                <span class="pull-right-container">
                                    <i class="fa fa-angle-left pull-right"></i>
                                </span>
                            </a>
                            <ul class="treeview-menu">
                                <li><a href="<?php echo base_url("lab_manager/appointment/form") ?>"><?php echo display('appointment') ?></a></li>
                                <li><a href="<?php echo base_url("lab_manager/test/form") ?>"><?php echo display('add_test') ?></a></li>
                                <li><a href="<?php echo base_url("lab_manager/test") ?>"><?php echo display('test_list') ?></a></li>
                                <li><a href="<?php echo base_url("lab_manager/package/form") ?>"><?php echo display('add_package') ?></a></li>
                                <li><a href="<?php echo base_url("lab_manager/package") ?>"><?php echo display('package_list') ?></a></li>
                            </ul>
                        </li>
                        ...
                        <li class="treeview <?php echo (($this->uri->segment(1) == "operation") ? "active" : null) ?>">
                            <a href="#">
                                <i class="fa fa-lightbulb-o"></i> <span><?php echo display('operation') ?> </span>
                                <span class="pull-right-container">
                                    <i class="fa fa-angle-left pull-right"></i>
                                </span>
                            </a>
                            <ul class="treeview-menu">
                                <li><a href="<?php echo base_url('operation/operation/add_theater') ?>"> <?php echo display('add_ot') ?></a></li>
                                <li><a href="<?php echo base_url('operation/operation/assign_ot') ?>"> <?php echo display('assign_ot') ?></a></li>
                                <li><a href="<?php echo base_url('operation/operation/add_equipment') ?>"> <?php echo display('add_equipment') ?></a></li>
                                <li><a href="<?php echo base_url('operation/operation/equipment_list') ?>"> <?php echo display('equipment_list') ?></a></li>
                                <li><a href="<?php echo base_url('operation/operation/assign_equipment') ?>"> <?php echo display('assign_equipment') ?></a></li>
                                <li><a href="<?php echo base_url('operation/operation/form') ?>"> <?php echo display('add_operation_report') ?></a></li>
                                <li><a href="<?php echo base_url('operation/operation/index') ?>"><?php echo display('operation_report') ?></a></li>
                            </ul>
                        </li>
