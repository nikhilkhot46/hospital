...
class Csupplier extends CI_Controller {
	...
	function __construct() {
        ...
        $this->load->model('dashboard_pharmacist/Suppliers');
	...
	public function index()
	{
		...
		$data['content']  = $this->load->view('dashboard_pharmacist/supplier/add_supplier_form',$data,true);
    ...
    public function insert_supplier()
    {
        ...
        if ($supplier == TRUE) {
            ...
            if(isset($_POST['add-supplier'])){
                redirect(base_url('dashboard_pharmacist/supplier/Csupplier/manage_supplier'));
                exit;
            }elseif(isset($_POST['add-supplier-another'])){
                redirect(base_url('dashboard_pharmacist/supplier/Csupplier'));
                exit;
            }
        }else{
	...
	public function manage_supplier()
	{
        ...
        $data['content']  = $this->load->view('dashboard_pharmacist/supplier/supplier',$data,true);
        $this->load->view('dashboard_pharmacist/main_wrapper',$data);
	}
	...
	{	
		...
		$data['content']  = $this->load->view('dashboard_pharmacist/supplier/edit_supplier_form',$data,true);
        $this->load->view('dashboard_pharmacist/main_wrapper',$data);
	}
	...
	{	
		...
		$data['content']  = $this->load->view('dashboard_pharmacist/supplier/supplier_details',$data,true);
        $this->load->view('dashboard_pharmacist/main_wrapper',$data);
	}
	...
	public function	supplier_ledger()
	{
        ...
        if($cat == "all")
        { 
            $url="dashboard_pharmacist/supplier/Csupplier/supplier_ledger_report";
        ...
        if($sup_sale == "2")
        { 
            $url="dashboard_pharmacist/supplier/Csupplier/supplier_sales_details".'/'.$supplier_id.'/'.$start.'/'.$end;
            redirect(base_url($url));
            exit;     
        }
        ...
        { 
            $url="dashboard_pharmacist/supplier/Csupplier/supplier_sales_summary".'/'.$supplier_id.'/'.$start.'/'.$end;
            redirect(base_url($url));
            exit;     
        }
        $sup_sale_summary=$this->input->post('cat');
        ...
        { 
            $url="dashboard_pharmacist/supplier/Csupplier/sales_payment_actual".'/'.$supplier_id.'/'.$start.'/'.$end;
            redirect(base_url($url));
            exit;     
        }
		...
		$data['content']  = $this->load->view('dashboard_pharmacist/supplier/supplier_ledger',$data,true);
        $this->load->view('dashboard_pharmacist/main_wrapper',$data);
	}
	...
	{	
		...
		$data['content']  = $this->load->view('dashboard_pharmacist/supplier/supplier_sales_details',$data,true);
        $this->load->view('dashboard_pharmacist/main_wrapper',$data);
	}
	...
	{	
        ...
        $config["base_url"] = base_url('dashboard_pharmacist/supplier/Csupplier/supplier_sales_summary/'.$supplier_id."/");
        ...
        $this->supplier_id=$supplier_id;
        $data['content']  = $this->load->view('dashboard_pharmacist/supplier/supplier_sales_summary',$data,true);
        $this->load->view('dashboard_pharmacist/main_wrapper',$data);
	}
	...
	{	
        ...
        $config["base_url"] = base_url('dashboard_pharmacist/supplier/Csupplier/sales_payment_actual/'.$supplier_id."/");
        ...
        $this->supplier_id=$supplier_id;
        $data['content']  = $this->load->view('dashboard_pharmacist/supplier/sales_payment_ledger',$data,true);
        $this->load->view('dashboard_pharmacist/main_wrapper',$data);
	}
    ...
    {   
        $config["base_url"] = base_url('dashboard_pharmacist/supplier/Csupplier/supplier_sales_details_all/');
