...
class Csettings extends CI_Controller {
	...
	public function index()
	{
		...
		$data['content']  = $this->load->view('dashboard_pharmacist/settings/new_bank',$data,true);
	...
	public function add_new_bank()
	{
		...
		if ($_FILES['signature_pic']['name']) {
	        ...
	        if ( ! $this->upload->do_upload('signature_pic'))
	        {
	            ...
	            redirect(base_url('dashboard_pharmacist/Csettings/index'));
	        }
	        else
	        {
		...
		redirect(base_url('dashoboard_pharmacist/Csettings/bank_list'));exit;
	}
	...
	public function bank_transaction()
	{
		...
		$data['content']  = $this->load->view('dashboard_pharmacist/settings/bank_debit_credit_manage',$data,true);
		$this->load->view('dashboard_pharmacist/main_wrapper',$data);;
	}
	...
	public function bank_debit_credit_manage_add()
	{
		...
		$this->session->set_userdata(array('message'=>display('successfully_added')));
		redirect(base_url('dashboard_pharmacist/Csettings/bank_list'));exit;
	}

	#==============Bank Ledger============#
	public function bank_ledger($bank_id)
	{
        $data = $this->lsettings->bank_ledger($bank_id);
		$data['content']  = $this->load->view('dashboard_pharmacist/settings/bank_ledger',$data,true);
		$this->load->view('dashboard_pharmacist/main_wrapper',$data);;
	}
	...
	{
        $data = $this->lsettings->bank_list( );
		$data['content']  = $this->load->view('dashboard_pharmacist/settings/bank',$data,true);
		$this->load->view('dashboard_pharmacist/main_wrapper',$data);;
	}
	#=============Bank edit==============#
	public function edit_bank($bank_id)
	{
        $data = $this->lsettings->bank_show_by_id($bank_id);
		$data['content']  = $this->load->view('dashboard_pharmacist/settings/edit_bank',$data,true);
		$this->load->view('dashboard_pharmacist/main_wrapper',$data);;
	}
	#============Update Bank=============#
	public function update_bank($bank_id)
	{
        ...
        $this->session->set_userdata(array('message'=>display('successfully_updated')));
        redirect('dashboard_pharmacist/Csettings/bank_list');
	}
	#==============Table list============#
	public function table_list()
	{
        ...
        #pagination starts
        #
        $config["base_url"] = base_url('dashboard_pharmacist/Csettings/table_list/');
