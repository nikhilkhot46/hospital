...
class Prescription extends CI_Controller {
	...
	public function index()
	{
		...
		$data['content'] = $this->load->view('dashboard_pharmacist/prescription/prescription',$data,true);
	...
	public function view($id = null) 
	{
		...
		$data['content'] = $this->load->view('dashboard_pharmacist/prescription/prescription_view',$data,true);
		$this->load->view('dashboard_pharmacist/main_wrapper',$data);
	}
