...
class Package extends CI_Controller {
    ...
    public function index()
    {
        ...
        $data['content'] = $this->load->view('dashboard_laboratorist/lab_manager/package_view', $data, true);
    ...
    public function form($id = null)
    {
        ...
        if (empty($id)) {
            ...
            if ($this->form_validation->run() === true) {
                ...
                redirect('dashboard_laboratorist/lab_manager/package/form');
            } else {
                $data['title'] = display('add_package');
                $data['tests_data'] = $this->lab_model->read_active_test();
                $data['content'] = $this->load->view('dashboard_laboratorist/lab_manager/package_form', $data, true);
                $this->load->view('dashboard_laboratorist/main_wrapper', $data);
            }
            ...
            if ($this->form_validation->run() === true) {
                ...
                redirect('dashboard_laboratorist/lab_manager/package/form/' . $postData['package_id']);
            } else {
