...
class Appointment extends CI_Controller {
    ...
    public function index()
    {
        ...
        $data['content'] = $this->load->view('lab_manager/appointment_view', $data, true);
    ...
    public function form($id = null)
    {
        ...
        $data['appointment'] = (object) $postData = array(
            ...
            'bill_generated' => $this->input->post('bill_generated', true),
        ...
        if (empty($id)) {
            ...
            if ($this->form_validation->run() === true) {
                if($this->input->post('admission_id', true) == "on"){
                    ...
                    if(empty($aid)){
                        ...
                        redirect('lab_manager/appointment/form');
                    }
                ...
                $data['test_options'] = $this->lab_model->read_test();
                $data['package_options'] = $this->lab_model->read_package();
                $data['content'] = $this->load->view('lab_manager/appointment_form', $data, true);
                $this->load->view('layout/main_wrapper', $data);
            }
            ...
            if ($this->form_validation->run() === true) {
                if($this->input->post('admission_id', true) == "on"){
                    ...
                    if(empty($aid)){
                        $this->session->set_flashdata('exception', display('patient_not_admitted'));
                        redirect('lab_manager/appointment/form/' . $postData['appointment_id']);
                    }
                    $postData['admission_id'] =  $aid->admission_id;
                }
                else{
    ...
    public function report()
    {
        ...
        redirect('lab_manager/appointment');
    }
