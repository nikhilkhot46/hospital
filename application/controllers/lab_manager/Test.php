...
class Test extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $data['content'] = $this->load->view('lab_manager/test_view', $data, true);
    ...
    public function form($id = null)
    {
        ...
        if (empty($id)) {
            ...
            if ($this->form_validation->run() === true) {
                ...
                redirect('lab_manager/test/form');
            } else {
                $data['title'] = display('add_test');
                $data['content'] = $this->load->view('lab_manager/test_form', $data, true);
                $this->load->view('layout/main_wrapper', $data);
            }
            ...
            if ($this->form_validation->run() === true) {
                ...
                redirect('lab_manager/test/form/' . $postData['test_id']);
            } else {
