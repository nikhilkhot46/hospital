...
class Bed extends CI_Controller {
    ...
    { 
        ...
        if (empty($id)) {
            ...
            if ($this->form_validation->run() === true) { 
                ...
                redirect('dashboard_receptionist/bed_manager/bed/form');
            } else {
                $data['title'] = display('add_bed');
                $data['content'] = $this->load->view('dashboard_receptionist/bed_manager/bed_form',$data,true);
                $this->load->view('dashboard_receptionist/main_wrapper',$data);
            } 
            ...
            if ($this->form_validation->run() === true) { 
                ...
                redirect('dashboard_receptionist/bed_manager/bed/form/'.$postData['id']);
            } else {
    ...
    public function delete($id = null) 
    {
        ...
        redirect('dashboard_receptionist/bed_manager/bed');
    }
