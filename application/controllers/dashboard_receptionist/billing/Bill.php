...
class Bill extends CI_Controller {
	...
	public function __construct()
	{
		...
		$this->load->model(array(
			'dashboard_receptionist/billing/bill_model',
			'dashboard_receptionist/billing/service_model', 
		));
	...
	{ 
        ...
        #pagination starts
        #
        $config["base_url"] = base_url('dashboard_receptionist/billing/bill/index');
	...
	public function form()
	{
		...
		if ($this->form_validation->run()) {
			...
			redirect('dashboard_receptionist/billing/bill/form/');
		} else {  
